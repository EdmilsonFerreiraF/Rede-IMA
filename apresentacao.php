    ...
    <div class="container">
        <main class="main">
            <section class="presentation">
                ...
                <div class="launch">
                    <h1 class="launch__title">Apresentação</h1>
                    <h2 class="launch__sub-title">Admirável Mundo da Educação a distância</h1>
                    <div class="launch__main">
                    </div>

                    <div class="launch__aside">
                    
                    <div class="launch__forward">
                            <a href="#" class="launch__link launch__link-1">
                                <div class="launch__wrap-legend-1 launch__wrap-legend">
                                    <h2 class="launch__legend launch__legend-1">Avance Seu Projeto</h2>
                                </div>
                                <div class="launch__image-1"></div>
                            </a>
                        </div>

                        <div class="launch__entrepreneurship">
                            <a href="#" class="launch__link launch__link-2">
                                <div class="launch__wrap-legend-2 launch__wrap-legend">
                                    <h2 class="launch__legend launch__legend-2">Empreendedorismo</h2>
                                </div>
                                <div class="launch__image-2"></div>
                            </a>
                        </div>

                        <div class="launch__education">
                            <a href="#" class="launch__link launch__link-3">
                                <div class="launch__wrap-legend-3 launch__wrap-legend">
                                    <h2 class="launch__legend launch__legend-3">Educação Positiva</h2>
                                </div>
                                <div class="launch__image-3"></div>
                            </a>
                        </div>

                        
                        <div class="launch__radio">
                            <a href="#" class="launch__link-5 launch__link">
                                <div class="launch__wrap-legend-4 launch__wrap-legend">
                                    <h2 class="launch__legend launch__legend-4">Rádio Escolar</h2>
                                </div>
                                <div class="launch__image-4"></div>
                            </a>
                        </div>

                        <div class="launch__show">
                            <a href="#" class="launch__link-5 launch__link">
                                <div class="launch__image-5"></div>
                            </a>
                        </div>

                        <div class="launch__ima-tec">
          <a href="#" class="launch__link-6 launch__link">
            <div class="launch__image-6"></div>
          </a>
        </div>

        <div class="launch__ima-productions">
          <a href="#" class="launch__link-7 launch__link">
            <div class="launch__image-7"></div>
          </a>
        </div>

        <div class="launch__sony">
          <a href="#" class="launch__link-8 launch__link">
            <div class="launch__image-8"></div>
          </a>
        </div>
                        </aside>
                    </div>
